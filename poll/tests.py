...
class QuestionIndexViewTests(TestCase):
    ...
    def two_past_questions(self):
        ...
        question2 = create_question(quesetion_text= "past question 2.",days = -5)
        response = self.client.get(reverse('poll:index'))
        self.assertQuerySetEqual(
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        ...
        self.assertEqual(response.status_code,200,'this is not right')
        
    def test_past_question(self):
        past_question = create_question(question_text = 'Past Quesetion.',days = -5)
